 ...
 <div class="mobile-menu-overlay"></div>
            ...
            <div class="page-header">
                <div class="row">
                    <div class="col-md-12 col-sm-12">
                        <div class="title">
                            <h4>Đăng ký thông tin đặt phòng</h4>
                        </div>
    ...
    <!-- form nhap nhan vien -->
        <div class="card-box mb-30 pd-20">
                ...
                <h4 class="fw-bold text-center text-uppercase">Nhập thông tin đặt phòng</h4>
                <form class="row m-4" action="module/cf_DKphong2.php" method="post">
                    ...
                    <div class="form-group">
                        <label class="form-label fw-bold">Thời Gian Đặt Phòng</label>
                        <div class="">
                            <input class="form-control" placeholder="dd/m/yy" type="datetime-local" name="tg_datphong">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group d-grid gap-2 col-4 mx-auto">
                        <input  type="submit" class="btn btn-success " value="Đăng Ký Đặt phòng"> 
                    </div>
                </form>           

 ...
 <div class="mobile-menu-overlay"></div>
    ...
    <!-- form nhap nhan vien -->
        <div class="card-box mb-30 pd-20">
                ...
                <form class="row m-4" action="module/cf_DKNphong2.php" method="post">
                <div class="col-md-3 form-group">
                        <label for="makh" class="form-label fw-bold">Mã KH : </label>
                        <input type="text" class="form-control" id="makh" name="makh" value="<?php echo $row ['makh'] ?>" required>
                    </div>
                    <div class="col-md-9 form-group">
                        <label for="tenkhachhang" class="form-label fw-bold">Tên khách hàng : </label>
                        <input type="text" class="form-control" id="tenkhachhang" name="tenkhachhang" value="<?php echo $row ['tenkhachhang'] ?>" required>
                    </div>
                    <div class="col-md-6 form-group">
                        <label for="sdt_kh" class="form-label fw-bold">Số Điện Thoại : </label>
                        <input type="text" class="form-control" id="sdt_kh" name="sdt_kh" value="<?php echo $row ['sdt_kh'] ?>" required>
                    </div>
                    <div class="col-md-6  form-group">
                        <label for="cmnd_kh" class="form-label fw-bold">CMND/CCCD Khách Hàng : </label>
                        <input type="text" class="form-control" id="cmnd_kh" name="cmnd_kh" value="<?php echo $row ['cmnd_kh'] ?>" required>
                    </div>
                    
                    <div class="col-md-3 form-group">
                        <label for="sl_khach" class="form-label fw-bold">Số Người : </label>
                        <input type="text" class="form-control" id="sl_khach" name="sl_khach" value="<?php echo $row ['sl_khach'] ?>" required>
                    </div>
                    <div class="col-md-3 form-group">
                    ...
                    <div class="col-md-3 form-group">
                        ...
                        <input type="text" class="form-control" id="maloaidv" name="maloaidv" value="<?php echo $row ['maloaidv'] ?>" required>
                    </div>

				...
				<table class="data-table table stripe hover nowrap">
                    ...
                    <?php foreach ($data as $row) : ?>
						<tr>
                            ...
                            <td ><button class="thcoler border border-white rounded-3 p-1 fw-bold"><?php echo $row['trangthaiphong']; ?></button></td>
							...
							<td>
								<div class="dropdown">
									...
									<div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
										...
										<a class="dropdown-item" href="DK_datphong.php?sid=<?php echo $row['maphong'];?>"><i class="icon-copy dw dw-file-39"></i> Đăng ký đặt phòng</a>
										<a class="dropdown-item" href="DK_nhanphong.php?sid=<?php echo $row['maphong'];?>"><i class="icon-copy dw dw-file-56"></i>Đăng ký nhận phòng</a>            
									</div>
								</div>
							</td>
						</tr>

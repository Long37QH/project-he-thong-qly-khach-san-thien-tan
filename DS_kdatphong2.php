							...
							<td>
								<div class="dropdown">
									...
									<div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                                        ...
                                        <a onclick="return confirm('Xác định huỷ đăng ký đặt phòng ?');" class="dropdown-item" href="./module/cf_huydatphong2.php?sid=<?php echo $row['makh'];?>"><i class="dw dw-delete-3"></i>Huỷ đặt phòng</a>            
									</div>
								</div>
							</td>
						</tr>

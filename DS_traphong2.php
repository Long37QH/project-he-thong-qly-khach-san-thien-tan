        ...
        <div class="page-header">
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <div class="title">
                        <h4>Danh Sách Khách Hàng Trả Phòng</h4>
                    </div>
        ...
        <table class="data-table table stripe hover nowrap">
                    ...
                    <?php foreach ($data as $row) : ?>
						<tr>
                            ...
                            <td><button class="thcoler border border-white rounded-3 "><?php echo $row['trangthaikh']; ?></button></td>
                            <td><?php echo $row['SotienTT']; ?> VNĐ</td>
							<td>
                                <a class="btn btn-info" href="hoadon2.php?sid=<?php echo $row['makh'];?>">Thanh Toán</a>	
							</td>
						</tr>
						<?php endforeach; ?>
					</tbody>

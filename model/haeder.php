			...
			<div class="user-info-dropdown">
				<div class="dropdown">
					...
					<div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
						<a class="dropdown-item" href="profile.php?sid=<?php echo $manv;?>"><i class="dw dw-user1"></i> Thông tin cá nhân</a>
				...
				<ul id="accordion-menu">
					<li class="dropdown">
						...
						<ul class="submenu">
							...
							<li><a href="add_NV.php">Thêm Mới Nhân Viên</a></li>
					...
					<li class="dropdown">
						...
						<ul class="submenu">
							<li><a href="DS_loaiDV.php">Phân loại dịch vụ</a></li>
							<li><a href="DS_dichvu.php">Danh sách dịch vụ</a></li>
					...
					<li class="dropdown">
						...
						<ul class="submenu">
							<li><a href="DS_phong.php">Danh sách phòng thuê</a></li>
					...
					<li class="dropdown">
						...
						<ul class="submenu">
							<li><a href="DS_KTphong.php">Kiểm tra phòng</a></li>
							<li><a href="DS_kdatphong.php">Kiểm tra thông tin khách</a></li>
						</ul>
					</li>
					<li class="dropdown">
						<a href="javascript:;" class="dropdown-toggle">
						...
						<ul class="submenu">
							<li><a href="DS_KTnhanphong.php">Kiểm tra thông tin phòng</a></li>
							<li><a href="DS_traphong.php">Danh sách khách hàng trả phong</a></li>
						</ul>
					</li>
					<li class="dropdown">
						<a href="javascript:;" class="dropdown-toggle">
						...
						<ul class="submenu">
							<li><a href="DS_TKehoadon.php">Thống kê hoá đơn</a></li>
					...
					<li class="dropdown">
						...
						<ul class="submenu">
							...
							<li><a href="DS_PhecaBT.php">Phê duyệt ca bảo trì</a></li>
